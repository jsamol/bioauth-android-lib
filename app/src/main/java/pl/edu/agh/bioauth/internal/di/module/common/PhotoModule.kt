...
import pl.edu.agh.bioauth.internal.biometrics.common.photo.PhotoLivenessDetector
...
internal class PhotoModule : AbstractModule() {
    ...
    private val livenessDetector: PhotoLivenessDetector = PhotoLivenessDetector()
